<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $messageAlert ="NAME: ".$name." TIME: ".$time." DATE: ".$date." SERVICE: ".$service." DETAILS: ".$details." EMAIL: ".$email."";
        ...
        $result = @mail($from, $subject, $messageAlert, $headers);
